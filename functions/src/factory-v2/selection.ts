...
export function assembleTimelineSelection(rawInput: SelectionInput): SelectionArtifact {
  ...
  return selectionArtifactSchema.parse(attachPayloadHash({
    ...
    sourceKnowledgeBundle: { pipelineVersion: "factory-v2-a.10" as const, schemaVersion: "factory-v2-a.3" as const, policyVersion: "evidence-first-v2-a.9" as const, promptVersion: "factory-v2-a-prompts.8" as const },
