...
export const V2_SCHEMA_VERSION = "factory-v2-a.1";
export const V2_POLICY_VERSION = "evidence-first-v2-a.1";
export const V2_PROMPT_VERSION = "factory-v2-a-prompts.1";
